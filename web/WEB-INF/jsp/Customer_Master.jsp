            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="widget">
                    ...
                    <div class="widget-body">
                        <form name="CMForm" autocomplete="off" id="CMForm" method="post" ng-submit="submitCustomer()" class="form-horizontal" novalidate>
                            <div class="col-md-12">
                                <div class="form-group col-md-6" ng-class="{ 'has-error' : CMForm.customerName.$invalid && (!CMForm.customerName.$pristine || submitted) }">
                                    <label class="col-md-5 control-label"><strong>Customer Name*</strong></label>
                                    <div class="col-md-7">
                                        <input type="text" class="form-control" name="customerName" id="customerName" 
                                               placeholder="Customer Name"
                                               ng-model="cust.customerName" required/>
                                        <small ng-show="CMForm.customerName.$invalid && (!CMForm.customerName.$pristine || submitted)" class="help-block">Customer Name is required.</small>
                                    </div>
                                </div>
                                <div class="form-group col-md-6" ng-class="{ 'has-error' : CMForm.address.$invalid && (!CMForm.address.$pristine || submitted)}">
                                    ...
                                    <div class="col-md-7">
                                        ...
                                        <small ng-show="CMForm.address.$invalid && (!CMForm.address.$pristine || submitted)" class="help-block">Customer Address is required.</small>
                                    </div>
                                </div>
                            </div>

                            <div class="col-md-12">
                                <div class="form-group col-md-6" ng-class="{ 'has-error' : CMForm.city.$invalid && (!CMForm.city.$pristine || submitted) }">
                                    <label class="col-md-5 control-label"><strong> City*</strong></label>
                                    <div class="col-md-7">
                                        <input type="text" class="form-control" name="city" id="city" 
                                               placeholder="City" ng-model="cust.city" required/>
                                        <small ng-show="CMForm.city.$invalid && (!CMForm.city.$pristine || submitted)" class="help-block">Customer City is required.</small>
                                    </div>
                                </div>
                                <div class="form-group col-md-6">
                                    ...
                                    <div class="col-md-7">
                                        <input type="text" class="form-control" name="postalCode" id="postalCode" 
                                               ng-model="cust.postalCode" placeholder="Postal Code"/>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group col-md-6" ng-class="{ 'has-error' : CMForm.country.$invalid && (!CMForm.country.$pristine || submitted) }">
                                    <label class="col-md-5 control-label"><strong> Country* </strong></label>
                                    <div class="col-md-7">
                                        <select class="form-control" name="country" id="country" 
                                                ng-model="cust.country.countryId" placeholder="Country" required>
                                            <option value="">-Select-</option>
                                            <option value="98">India</option>
                                        </select>
                                        <small ng-show="CMForm.country.$invalid && (!CMForm.country.$pristine || submitted)" class="help-block">Customer Country is required.</small>
                                    </div>
                                </div>
                                <div class="form-group col-md-6" ng-class="{ 'has-error' : CMForm.state.$invalid && (!CMForm.state.$pristine || submitted) }">
                                    ...
                                    <div class="col-md-7">
                                        ...
                                        <small ng-show="CMForm.state.$invalid && (!CMForm.state.$pristine || submitted)" class="help-block">Customer State is required.</small>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group col-md-6" ng-class="{ 'has-error' : CMForm.TIN.$invalid && (!CMForm.TIN.$pristine || submitted) }">
                                    ...
                                    <div class="col-md-7">
                                        <input type="text" class="form-control" name="TIN" id="TIN"
                                               placeholder="TIN" ng-model="cust.tin" required/>
                                        <small ng-show="CMForm.TIN.$invalid && (!CMForm.TIN.$pristine || submitted)" class="help-block">Customer TIN No. is required.</small>
                                    </div>
                                </div>
                            </div> 
                            <div class="col-md-12">
                                <div class="form-group col-md-6">
                                    ...
                                    <div class="col-md-7">
                                        <input type="text" class="form-control capsON" name="CSTNo" id="CSTNo"
                                               placeholder="CSTNO" ng-model="cust.cstno"/>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-md-7">
                                        <div class="input-group">
                                            <input type="text" datepicker class="form-control" name="CSTDate" id="CSTDate" 
                                                   placeholder="CSTDate" ng-model="cust.cstdate" readonly>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <div class="col-md-7">
                                        <input type="text" class="form-control capsON" name="phone" id="phone"  
                                               ng-model="cust.phone" placeholder="Phone No"/>
                                    </div>
                                </div>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <div class="col-md-7">
                                        <input type="text" class="form-control capsON" name="emailId" id="emailId"  
                                               ng-model="cust.emailId" placeholder="Email Id"/>
                                    </div>
                                </div>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <div class="col-md-7">
                                        <input type="text" class="form-control capsON" name="website" id="website"  
                                               ng-model="cust.website" placeholder="Website"/>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group col-md-6">
                                    ...
                                    <div class="col-md-7">
                                        <input type="text" class="form-control capsON" name="contact" id="contact"  
                                               ng-model="cust.contact" placeholder="Contact"/>
                                    </div>
                                </div>
                                <div class="form-group col-md-6">
                            ...
                            <div class="form-group">
                                <div class="col-md-offset-6 col-md-8">                                                                            
                                    <button type="submit" class="btn btn-blue" ng-click="submitted" data-accesskey='s'><u class="scut">S</u>ubmit</button>
                                </div>
                            </div>                                
                        </form>
                        <div id="test"></div>
