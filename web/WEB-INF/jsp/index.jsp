                            ...
                            <ul class="account-area">
                                ...
                                <li>
                                    ...
                                    <ul class="pull-right dropdown-menu dropdown-arrow dropdown-messages">
                                        <li>
                                            <a href="#">
                                                <img src="<c:url value="/assets/img/avatars/divyia.jpg"/>" class="message-avatar" alt="Divyia Austin">
                                                <div class="message">
                                        ...
                                        <li>
                                            <a href="#">
                                                <img src="<c:url value="/assets/img/avatars/bing.png"/>" class="message-avatar" alt="Microsoft Bing">
                                                <div class="message">
                                                    <span class="message-sender">
                                                        Bing.com
                                                    </span>
                                        ...
                                        <li>
                                            <a href="#">
                                                <img src="<c:url value="/assets/img/avatars/adam-jansen.jpg"/>" class="message-avatar" alt="Divyia Austin">
                                                <div class="message">
                                                    <span class="message-sender">
                                                        Nicolas
                                                    </span>
                ...
                <div id="chatbar" class="page-chatbar">
                    <div class="chatbar-contacts">
                        ...
                        <ul class="contacts-list">
                            ...
                            <li class="contact">
                                <div class="contact-avatar">
                                    <img src="<c:url value="/assets/img/avatars/Nicolai-Larson.jpg"/>" />
                                </div>
                                <div class="contact-info">
                            ...
                            <li class="contact">
                                <div class="contact-avatar">
                                    <img src="<c:url value="/assets/img/avatars/John-Smith.jpg"/>" />
                                </div>
                                <div class="contact-info">
                            ...
                            <li class="contact">
                                <div class="contact-avatar">
                                    <img src="<c:url value="/assets/img/avatars/Osvaldus-Valutis.jpg"/>" />
                                </div>
                                <div class="contact-info">
                            ...
                            <li class="contact">
                                <div class="contact-avatar">
                                    <img src="<c:url value="/assets/img/avatars/Javi-Jimenez.jpg"/>" />
                                </div>
                                <div class="contact-info">
                            ...
                            <li class="contact">
                                <div class="contact-avatar">
                                    <img src="<c:url value="/assets/img/avatars/Stephanie-Walter.jpg"/>" />
                                </div>
                                <div class="contact-info">
                            ...
                            <li class="contact">
                                <div class="contact-avatar">
                                    <img src="<c:url value="/assets/img/avatars/Sergey-Azovskiy.jpg"/>" />
                                </div>
                                <div class="contact-info">
                            ...
                            <li class="contact">
                                <div class="contact-avatar">
                                    <img src="<c:url value="/assets/img/avatars/Lee-Munroe.jpg"/>" />
                                </div>
                                <div class="contact-info">
                                                ...
                                                <div class="tickets-container">
                                                    <ul class="tickets-list">
                                                        <li class="ticket-item">
                                                            <div class="row">
                                                                <div class="ticket-user col-lg-6 col-sm-12">
                                                                    <img src="<c:url value="/assets/img/avatars/adam-jansen.jpg"/>" class="user-avatar">
                                                        ...
                                                        <li class="ticket-item">
                                                            <div class="row">
                                                                <div class="ticket-user col-lg-6 col-sm-12">
                                                                    <img src="<c:url value="/assets/img/avatars/divyia.jpg"/>" class="user-avatar">
                                                        ...
                                                        <li class="ticket-item">
                                                            <div class="row">
                                                                <div class="ticket-user col-lg-6 col-sm-12">
                                                                    <img src="<c:url value="/assets/img/avatars/Matt-Cheuvront.jpg"/>" class="user-avatar">
                                                        ...
                                                        <li class="ticket-item">
                                                            <div class="row">
                                                                <div class="ticket-user col-lg-6 col-sm-12">
                                                                    <img src="<c:url value="/assets/img/avatars/Sergey-Azovskiy.jpg"/>" class="user-avatar">
                                                        ...
                                                        <li class="ticket-item">
                                                            <div class="row">
                                                                <div class="ticket-user col-lg-6 col-sm-12">
                                                                    <img src="<c:url value="/assets/img/avatars/John-Smith.jpg"/>" class="user-avatar">
