...
//        auth.inMemoryAuthentication().withUser("dba").password("dba").roles("ADMIN","DBA");
        ...
        auth.jdbcAuthentication().dataSource(dataSource)
                ...
                .authoritiesByUsernameQuery("SELECT u_username, role_rolename FROM system_users JOIN user_roles ON u_userid = ur_userid JOIN role ON role_rolecode = ur_rolecode WHERE u_username=?");
    }
